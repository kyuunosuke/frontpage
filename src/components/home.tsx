...
const Home = () => {
  ...
  // Mock categories for the filter panel
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row w-full md:w-auto gap-2">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg md:hidden"
              >
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Browse through our collection of active competitions and contests
          </p>
        </div>
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">
                Find and enter the best competitions, contests, and sweepstakes
                all in one place.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} Competition Directory. All
              rights reserved.
            </p>
          </div>
        </div>
